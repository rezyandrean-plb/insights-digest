...
// Only include items with a valid href (no "#" or empty); icons without links are omitted
const socialLinks = [
    {
        label: "Facebook",
        href: "https://www.facebook.com/InsightsDigest/",
        icon: (
    ...
    {
        label: "Spotify",
        href: "https://open.spotify.com/show/3XFLamzyEFP5FzQwX9lcV0",
        icon: (
            <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
    ...
    {
        label: "TikTok",
        href: "https://www.tiktok.com/@insights_digest",
        icon: (
            <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
    ...
    {
        label: "LinkedIn",
        href: "https://www.linkedin.com/showcase/insightsdigest/",
        icon: (
            <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
    ...
    {
        label: "Threads",
        href: "https://www.threads.com/@insights_digest?hl=en",
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-10">
                    ...
                    <div>
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="mt-4 group inline-flex items-center gap-3 rounded-xl bg-white/80 border border-secondary/15 p-3 pr-4 w-full max-w-[286px] shadow-sm hover:shadow-md hover:border-[#195F60]/30 transition-all duration-200"
                        >
